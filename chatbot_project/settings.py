...
CHANNEL_LAYERS = {
    "default": {
        "BACKEND": "channels.layers.InMemoryChannelLayer", # TODO: to change to redis channel layer in future
    },
}
...
AUTH_USER_MODEL = 'chatbot_app.UserProfile'
...
# Email configuration using twilio (SendGrid)
